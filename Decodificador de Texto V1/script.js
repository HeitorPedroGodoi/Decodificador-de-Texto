...
function encrypt() {
    ...
    if (input1.value.length == 0) {
        ...
        var txt =  text.replace(/e/igm, 'McLovin');
        var txt = txt.replace(/i/igm, 'Terraformars');
        var txt = txt.replace(/a/igm, 'SweetLoveInDisguise');
        var txt = txt.replace(/o/igm, 'Okotber');
        var txt = txt.replace(/u/igm, 'Djin123');
